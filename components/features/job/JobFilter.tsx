...
import { LocalSearch } from "@/components/shared";
import {
  Select,
  SelectContent,
  SelectGroup,
  ...
  return (
    <div className="relative mt-11 flex w-full justify-between gap-5 max-sm:flex-col sm:items-center">
      ...
      <Select onValueChange={(value) => handleUpdateParams(value)}>
        <SelectTrigger className="body-normal border-light800-dark300 bg-light800-dark300 text-dark500-light700 line-clamp-1 flex min-h-[56px] items-center gap-3 border p-4 sm:max-w-[210px]">
          <Image
