    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          actionButton:
            "group-[.toast]:bg-slate-900 group-[.toast]:text-slate-50 font-medium dark:group-[.toast]:bg-slate-50 dark:group-[.toast]:text-slate-900",
          cancelButton:
            "group-[.toast]:bg-slate-100 group-[.toast]:text-slate-500 font-medium dark:group-[.toast]:bg-slate-800 dark:group-[.toast]:text-slate-400",
        },
      }}
      {...props}
    />
